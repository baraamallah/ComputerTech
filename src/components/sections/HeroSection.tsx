  ...
  return (
    <section id="home" className="py-20 md:py-32 bg-gradient-to-b from-background to-background/80 dark:from-background dark:to-muted/10">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-foreground min-h-[72px] md:min-h-[90px]"> {/* Added min-height to prevent layout shift */}
